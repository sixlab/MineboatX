...
public class SecretService {
     ...
     * @throws Exception
     */
    public String encrypt(Integer strIn) throws Exception {
        return byteArr2HexStr(encrypt(strIn.toString().getBytes()));
    }
     ...
     * @throws Exception
     */
    public Integer decryptInt(String strIn) throws Exception {
